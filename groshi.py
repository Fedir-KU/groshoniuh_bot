...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "/day, /dayall, /week, /weekall, /month, /monthall"
    )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    df = _prepare_df()
    today = date.today()
    total_today = df[(df['user']==user)&(df['date']==today)]['sum'].sum()
    if total_today > 250:
...
# ——— Команди звітів з обгорткою try/except ———
async def day_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /day: {e}")
...
async def dayall_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        tb = traceback.format_exc()
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /dayall: {e}")
...
async def week_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        tb = traceback.format_exc()
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /week: {e}")
...
async def weekall_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        tb = traceback.format_exc()
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /weekall: {e}")
...
async def month_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        tb = traceback.format_exc()
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /month: {e}")
...
async def monthall_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        tb = traceback.format_exc()
        print(tb)
        await update.message.reply_text(f"⚠️ Помилка в /monthall: {e}")
